...
CronUI.prototype.render = function () {
  ...
  /** Build some static data *******************/
      ...
      // options for labelMinutes in an hour
  let str_opt_mih = '';
  for (let i = 0; i < 60; i++) {
    let j = (i < 10) ? '0' : '';
  ...
  el.insertAdjacentHTML('beforeend', '<span class="cron-period">'
      + '<select>' + str_opt_period + '</select></span>');
